...
import "../components_css/pages_about2.css"
...
export default function About() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // FIXED: Adjusted for scroll-over effect - content scrolls up over presence
      const threshold = window.innerHeight * 0.8 // When content should start covering presence
  ...
  return (
    <div className="About-container">
      ...
      <div
        className={`About-presence-section ${showPresence ? "About-presence-visible" : "About-presence-hidden"}`}
        style={{
          // REMOVED: parallax transform - presence stays fixed
          opacity: showPresence ? 1 : 0,
        }}
      >
        <div className="About-presence-background">
          <div className="About-world-map-bg"></div>
          <div className="About-world-map-container">
            <div className="About-globe-sphere-bg">
              <div className="About-latitude-lines">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className={`About-lat-line About-lat-${i}`}></div>
                ))}
              </div>
              <div className="About-longitude-lines">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className={`About-lng-line About-lng-${i}`}></div>
                ))}
              </div>
            </div>
            <div className="About-connection-points">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className={`About-connection-point About-point-${i}`}>
                  <div className="About-pulse-ring"></div>
                  <div className="About-connection-dot"></div>
                </div>
              ))}
            </div>
            <div className="About-network-lines">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className={`About-network-line About-line-${i}`}></div>
              ))}
            </div>
          </div>
          <div className="About-globe-pattern"></div>
          <div className="About-globe-grid"></div>
          <div className="About-globe-dots"></div>
          <div className="About-connection-lines"></div>
        </div>

        <div className="About-presence-content">
          <div className="About-presence-header About-scroll-animate About-from-top">
            <div className="About-globe-icon">
              <div className="About-globe-sphere">
                <div className="About-globe-ring"></div>
                <div className="About-globe-ring-2"></div>
                <div className="About-globe-center"></div>
              </div>
            </div>
            <h1 className="About-presence-title">Our Global Presence</h1>
            <p className="About-presence-subtitle">
              Connecting smart cities worldwide with innovative automation solutions
            </p>
          </div>

          <div className="About-presence-main">
            <div className="About-presence-text About-scroll-animate About-from-left">
              <h2 className="About-company-intro">
                Hello,
                <br />
                We're <span className="About-company-highlight">ISTL ENERGY</span>
              </h2>
              <p className="About-presence-description">
                Our presence spans across continents, delivering intelligent automation solutions to smart cities
                worldwide. we're building the future of connected infrastructure.
              </p>
            </div>

            <div className="About-office-locations About-scroll-animate About-from-right">
              <div
                className="About-office-card About-scroll-animate About-from-bottom"
              ...
              >
                ...
                <p className="About-office-description">Leading smart city transformations across India, Singapore.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={`About-main-content ${!showPresence ? "About-main-content-visible" : ""}`}>
