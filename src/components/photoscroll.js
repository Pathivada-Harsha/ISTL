...
// import '../components_css/photoscroll.css';
...
//       description: "Leading India's renewable energy transformation with innovative solar, substation, and smart metering technologies.",
//       alignment: "center"
//     },
//     {
//       title: "SOLAR EXCELLENCE",
//       subtitle: "CLEAN • EFFICIENT • RELIABLE", 
//       description: "Delivering cutting-edge solar installations across India, powering communities with sustainable energy solutions.",
//       alignment: "left"
//     },
//     {
//       title: "1000+ MW",
//       subtitle: "RENEWABLE CAPACITY",
//       description: "Successfully installed and commissioned solar projects nationwide, contributing to India's green energy goals.",
//       alignment: "right"
//     },
//     {
//       title: "SMART INFRASTRUCTURE",
//       subtitle: "SUBSTATIONS & IOT SOLUTIONS",
//       description: "Building robust electrical infrastructure with advanced smart metering and IoT technologies for efficient energy management.",
//       alignment: "center"
//     },
//     {
//       title: "POWERING INDIA",
//       subtitle: "SUSTAINABLE FUTURE AHEAD",
//       description: "Join us in transforming India's energy landscape with reliable, innovative, and environmentally conscious solutions.",
//       alignment: "left"
//     }
//   ];
...
function ScrolledCom() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sectionHeight = window.innerHeight;
      const triggerPoint = sectionHeight * 0.5; // Trigger at 50% of first section
      const endPoint = sectionHeight * 1.5; // Stop triggering after 150% scroll
  ...
  // Typing animation effect - faster timing
  useEffect(() => {
    if (animationStarted && currentWordIndex < typingWords.length) {
      ...
      }, 300); // Reduced from 800ms to 300ms for faster typing
  ...
  return (
    <div 
      ...
      style={{ 
        ...
        height: `${contentSections.length * 100}vh`
      }}
    >
      {/* Scrolling Content Sections */}
      {contentSections.map((section, index) => {
      ...
      >
        <h1 className="ps-typing-text-middle">
          {typingText}
